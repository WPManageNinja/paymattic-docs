...
# Install and Activate Paymattic
...
![Adding Paymattic plugin directly from WordPress](/images/getting-started-with-paymattic/install-paymattic/Adding-Paymattic-plugin-directly-from-WordPress-scaled.webp)

Finally, to activate the Paymattic plugin, click on the **Activate** button.

![Activating Paymattic plugin](/images/getting-started-with-paymattic/install-paymattic/Activate-button-scaled.webp)
...
![Upgrade to Pro button in Paymattic dashboard](/images/getting-started-with-paymattic/install-paymattic/Upgrade-to-Pro-button-scaled.webp)
...
![Download Paymattic Pro and get license key](/images/getting-started-with-paymattic/install-paymattic/Get-the-Zip-file-and-license-key.webp)
...
![Add New Plugin button in WordPress](/images/getting-started-with-paymattic/install-paymattic/Add-New-Plugin-button-from-Plugins-page-scaled.webp)
...
![Upload and install Paymattic Pro plugin](/images/getting-started-with-paymattic/install-paymattic/Upload-plugin-choose-file-install-now-scaled.webp)
...
![Activate Paymattic Pro plugin](/images/getting-started-with-paymattic/install-paymattic/Activate-Plugin-button.webp)
...
![Activate Paymattic Pro license key](/images/getting-started-with-paymattic/install-paymattic/Activate-License-Key-scaled.webp)
...
![Update Paymattic plugin](/images/getting-started-with-paymattic/install-paymattic/Update-option-of-Paymattic-scaled.webp)
