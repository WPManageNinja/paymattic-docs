...
![Opening a form to edit in Paymattic](/images/form-settings/create-custom-css-js/1.-Open-desired-form-5-scaled.webp)
...
![Custom CSS/JS settings in form editor](/images/form-settings/create-custom-css-js/2.-Settings-tab-and-Custom-CSSJS-option-scaled.webp)
