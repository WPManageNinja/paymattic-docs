...
Additionally, read this [Documentation](/use-payment-method-fields) to learn how you can add your desired Payment method/s to your form.
:::
...
![Opening a payment form in Paymattic](/images/form-settings/customize-payment-settings/1.-Open-desired-form-1-scaled.webp)
...
![Accessing form settings through three-dot menu](/images/form-settings/customize-payment-settings/2.-Settings-option-under-Three-dot-icon--scaled.webp)
...
![Payment settings section in form editor](/images/form-settings/customize-payment-settings/3.-Payment-under-Form-Settings-scaled.webp)
...
![Stripe payment settings configuration](/images/form-settings/customize-payment-settings/4.-Stripe-Settings.webp)
...
![Stripe metadata configuration](/images/form-settings/customize-payment-settings/5.-Stripe-Meta-Data.webp)
...
![Configuring accepted payment methods](/images/form-settings/customize-payment-settings/6.-Limit-accepted-methods.webp)
...
![Stripe account configuration](/images/form-settings/customize-payment-settings/7.-Stripe-Account.webp)
...
![PayPal settings configuration](/images/form-settings/customize-payment-settings/8.-PayPal-Settings.webp)
...
![Transaction type selection](/images/form-settings/customize-payment-settings/9.-Transaction-Type.webp)
