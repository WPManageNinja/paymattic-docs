...
![](/images/integrations/integrate-fluentcommunity/1.-Activate-Paymattic-plugin-scaled.webp)

Now, click the **View Settings** button and it redirects you to the **Paymattic Dashboard.**

![](/images/integrations/integrate-fluentcommunity/2.-View-Settings-button-scaled.webp)
...
![](/images/integrations/integrate-fluentcommunity/5.-adding-Fluent-Community-Integration-feed-scaled.webp)
...
![](/images/integrations/integrate-fluentcommunity/6.-All-options-of-Fluent-Community-Integration-Feed-.webp)
...
![](/images/integrations/integrate-fluentcommunity/7.-Added-Fluent-Community-integration-feed-scaled.webp)
...
![](/images/integrations/integrate-fluentcommunity/8.-Copy-ShortCode-scaled.webp)
...
![](/images/integrations/integrate-fluentcommunity/9.-Paste-the-ShortCode-in-default-Paymattic-Dashboard-scaled.webp)
...
![](/images/integrations/integrate-fluentcommunity/10.-Preview-of-the-Fluent-Community-Form.webp)
...
> To learn more details about the **Paymattic User Dashboard**, read this [Documentation](/add-user-dashboard-module). Plus, to get access to this feature, you need the [Paymattic Pro Plugin](https://paymattic.com/docs/how-to-install-and-activate-paymattic-in-wordpress/#1-toc-title).

Once your users fill in the form, the user dashboard will look like the screenshot below.

![](/images/integrations/integrate-fluentcommunity/11.-Paymattic-User-Dashboard.webp)
