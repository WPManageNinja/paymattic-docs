...
![Mailchimp Settings Icon](/images/integrations/integrate-mailchimp/Mailchimps-Settings-Icon-scaled.webp)
...
![Enable Mailchimp integration](/images/integrations/integrate-mailchimp/Enable-Mailchimp-integration-scaled.webp)
...
![Profile icon in Mailchimp](/images/integrations/integrate-mailchimp/Profile-icon-scaled.webp)

Now, open the **Extras** tab and select the **API keys** from the dropdown list.

![Extras API keys menu](/images/integrations/integrate-mailchimp/Extras-API-kyes-scaled.webp)

Then, press the **Create A Key** button.

![Create API Key button](/images/integrations/integrate-mailchimp/Create-a-Key-button.webp)

Provide a **Name** for your API key and click the **Generate Key** button.

![Generate Key button](/images/integrations/integrate-mailchimp/Generate-Key-button.webp)

Finally, your Mailchimp API key is generated, copy it by clicking the **Copy to Clipboard** button.

![Copy API Key](/images/integrations/integrate-mailchimp/Copy-API-Key.webp)
...
![Paste Mailchimp API key](/images/integrations/integrate-mailchimp/Paste-Mailchimp-API-key-scaled.webp)
...
![Open desired form](/images/integrations/integrate-mailchimp/Open-desired-form-9-scaled.webp)
...
![Add new integration](/images/integrations/integrate-mailchimp/Add-new-integration-dropdown-Mailchimp-scaled.webp)
...
![Name and List selection](/images/integrations/integrate-mailchimp/Name-List-of-Add-new-mailchimp-feed-page.webp)
...
![Mailchimp integration settings](/images/integrations/integrate-mailchimp/Add-New-Mailchimp-Integration-Feed-page.webp)
...
![Added Mailchimp Integration Feed](/images/integrations/integrate-mailchimp/Added-Mailchimp-Integration-Feed-scaled.webp)
...
![Preview of Mailchimp contacts](/images/integrations/integrate-mailchimp/Preview-of-Mailchimp-scaled.webp)
