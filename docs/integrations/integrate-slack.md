...
![](/images/integrations/integrate-slack/Slacks-Settings-Icon-scaled.webp)

Click the **Toggle** button and your **Slack** integration module will be enabled.

![](/images/integrations/integrate-slack/Enabled-Slack-Integration-module-scaled.webp)
...
![](/images/integrations/integrate-slack/Open-desired-form-4-scaled.webp)
...
![](/images/integrations/integrate-slack/Add-new-integration-dropdown-slack-scaled.webp)
...
![](/images/integrations/integrate-slack/Add-New-Slack-Integration-Feed-page.webp)
...
![](/images/integrations/integrate-slack/Create-an-App-scaled.webp)

Select the **From Scratch** option.

![](/images/integrations/integrate-slack/From-scratch.webp)
...
![](/images/integrations/integrate-slack/App-name-workspace-Create-app.webp)
...
![](/images/integrations/integrate-slack/Add-ew-webhook-to-your-workspace-scaled.webp)
...
![](/images/integrations/integrate-slack/Select-for-a-channel.webp)
...
![](/images/integrations/integrate-slack/Copy-Webhook-URL-2.webp)
...
![](/images/integrations/integrate-slack/Paste-the-Slack-Webhook-URL.webp)
...
![](/images/integrations/integrate-slack/Added-slack-integration-feed-scaled.webp)
...
![](/images/integrations/integrate-slack/Preview-of-Slack.webp)
