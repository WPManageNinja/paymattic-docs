---
title: "Integrate Telegram with Paymattic"
category: "Integrations"
---

# Integrate Telegram with Paymattic
...
![](/images/integrations/integrate-telegram/Telegrams-Settings-Icon-scaled.webp)
...
![](/images/integrations/integrate-telegram/Enable-Telegram-Integration-scaled.webp)
...
![](/images/integrations/integrate-telegram/Start-chatting-with-@BotFaher-scaled.webp)

Then **create a new bot** by sending the **‘/newbot’** command using the help message.

![](/images/integrations/integrate-telegram/newbot-link.webp)
...
![](/images/integrations/integrate-telegram/Copy-the-Bot-Token.webp)
...
![](/images/integrations/integrate-telegram/Added-Bot-as-Admin.webp)
...
![](/images/integrations/integrate-telegram/Copy-the-Chat-ID.webp)
...
![](/images/integrations/integrate-telegram/Paste-the-Bot-token-Chat-ID-of-Gorup-scaled.webp)
...
![](/images/integrations/integrate-telegram/Open-desired-form-5-scaled.webp)
...
![](/images/integrations/integrate-telegram/Add-new-integration-dropdown-telegram-scaled.webp)
...
![](/images/integrations/integrate-telegram/Add-New-Telegram-Integration-Feed-page.webp)
...
![](/images/integrations/integrate-telegram/Added-Telegram-Integration-Feed-scaled.webp)
...
![](/images/integrations/integrate-telegram/Preview-of-integrated-Telegram.webp)
