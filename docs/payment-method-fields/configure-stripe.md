...
![Stripe Settings](/images/payment-method-fields/configure-stripe/Payment-Gateway-Stripe-1-scaled.webp)
...
![Payment Mode Settings](/images/payment-method-fields/configure-stripe/Payment-Mode-Public-key-Secret-key.webp)
...
![Stripe Developer Settings](/images/payment-method-fields/configure-stripe/Developers-API-Key-scaled.webp)

Here, you will get both your **Publishable Key** and **Secret Key** for configuration. Copy them.

![Stripe API Keys](/images/payment-method-fields/configure-stripe/Publishable-key-Secret-key-from-Stripe-account.webp)
...
![Configure Stripe Keys](/images/payment-method-fields/configure-stripe/Paste-the-public-and-secret-keys-in-Paymattic-scaled.webp)
...
![Company Settings](/images/payment-method-fields/configure-stripe/Company-Name-and-Stripe-Meta-Data.webp)
...
![Webhook Settings](/images/payment-method-fields/configure-stripe/Copy-Webhook-URL-and-Events.webp)
...
![Stripe Webhooks](/images/payment-method-fields/configure-stripe/Webhooks-from-Developers-section-scaled.webp)

Click the **+Create an endpoint** button.

![Create Webhook](/images/payment-method-fields/configure-stripe/Create-an-endpoint-button-scaled.webp)
...
![Select Events](/images/payment-method-fields/configure-stripe/Select-events-to-send-scaled.webp)
...
![Configure Endpoint](/images/payment-method-fields/configure-stripe/Endpoint-webhook-URL-scaled.webp)

## Add Stripe in Forms

Once you finish setting up your **Stripe** payment gateway, you can easily add this payment method to any of your existing [Payment Form](/create-payment-form).

If you do not have any existing forms, read this [Create a Form from Scratch](/create-form-from-scratch) or [Create a Form using Templates](/simple-form-templates) documentation to create one.

To learn the detailed process of adding a payment method to an existing form, read this [Documentation](/use-payment-method-fields).
...
[Form Specific Payment Settings](/customize-payment-settings)
