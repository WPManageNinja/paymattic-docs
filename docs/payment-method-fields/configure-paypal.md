...
To get access to the [PayPal](https://paypal.com/) payment gateway, you need the [Paymattic Pro Plugin](/install-paymattic).
:::
...
![PayPal Settings Tab in Paymattic](/images/payment-method-fields/configure-paypal/Paypal-tab-under-Payment-Gateway-scaled.webp)
...
![PayPal Basic Settings](/images/payment-method-fields/configure-paypal/Payment-Mode-Paypal-Email.webp)
...
![PayPal Advanced Settings](/images/payment-method-fields/configure-paypal/Disable-IPN-Verification-Checkout-Logo.webp)
...
![PayPal Confirmation Settings](/images/payment-method-fields/configure-paypal/Confirmation-Page-Settings.webp)
...
![PayPal Recurring Payments Settings](/images/payment-method-fields/configure-paypal/PayPal-for-Recurring-Payments.webp)
...
2. For new forms:
   - [Create a Form from Scratch](/create-form-from-scratch)
   - [Use Form Templates](/simple-form-templates)

3. Learn more about [adding payment methods](/use-payment-method-fields)
...
Need to customize PayPal settings for a specific form? Check out our guide on [Form-Specific Payment Settings](/customize-payment-settings).
