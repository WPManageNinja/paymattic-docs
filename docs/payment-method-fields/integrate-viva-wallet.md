---
title: "Integrate Viva Wallet With Paymattic"
category: "Payment Method Fields"
---
# Integrate Viva Wallet With Paymattic
...
![Install and Activate Viva Wallet](/images/payment-method-fields/integrate-viva-wallet/Payment-Gateway-Viva-Wallet-Install-Activate-Vi-a-wallet-button-scaled.webp)
...
![Viva Wallet Credentials Fields](/images/payment-method-fields/integrate-viva-wallet/Payent-mode-Source-code-Merchant-ID-API-Key-Client-ID-Client-Secret.webp)
...
![Viva Wallet Dashboard](/images/payment-method-fields/integrate-viva-wallet/Viava-Wallet-Dashboard-2-scaled.webp)

3. In your Viva Wallet profile settings, create a Web App:
   - Select **Sales > Online Payment > Website/Apps**

![Viva Wallet Web Apps](/images/payment-method-fields/integrate-viva-wallet/Viva-Web-Apps-3-scaled.webp)

4. Click the **Add Website/App** button.

![Add Website/App in Viva Wallet](/images/payment-method-fields/integrate-viva-wallet/Viva-Wallet-Add-Webhook-4-scaled.webp)
...
![Configure Web App Settings](/images/payment-method-fields/integrate-viva-wallet/Viva-Wallet-web-app-5-scaled.webp)

::: tip
You can find your Domain Name, Success URL, and Failure URL in the Viva Wallet Settings section of Paymattic.
:::

![Copy Webhook URLs](/images/payment-method-fields/integrate-viva-wallet/Copy-the-webhook-URLs-1.webp)
...
![API Access Settings](/images/payment-method-fields/integrate-viva-wallet/Viva-wallet-API-7-scaled.webp)
...
![Access Credentials](/images/payment-method-fields/integrate-viva-wallet/Viva-wallet-Access-key-8-scaled.webp)
...
![Configure Viva Wallet Settings](/images/payment-method-fields/integrate-viva-wallet/Paste-all-the-credential-scaled.webp)
...
![Copy Webhook URLs](/images/payment-method-fields/integrate-viva-wallet/Copy-the-webhook-URLs.webp)
...
![Viva Wallet Webhook Settings](/images/payment-method-fields/integrate-viva-wallet/Viva-wallet-Webhook-9-1-scaled.webp)
...
![Configure Webhook](/images/payment-method-fields/integrate-viva-wallet/Viva-wallet-webhook-verify-11-scaled.webp)
