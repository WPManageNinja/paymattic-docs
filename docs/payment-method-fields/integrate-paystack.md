...
![Paystack Settings Page in Paymattic](/images/payment-method-fields/integrate-paystack/Payment-gateway-Paystack-Paystack-settings-scaled.webp)
...
![Copy Paystack API Keys](/images/payment-method-fields/integrate-paystack/Copy-the-public-key-secret-key-from-paystack-scaled.webp)
...
![Configure Paystack Credentials in Paymattic](/images/payment-method-fields/integrate-paystack/Paste-the-API-Secret-key-scaled.webp)
