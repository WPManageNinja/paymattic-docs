...
![Tutor LMS Settings Icon](/images/lms-integrations/integrate-tutor-lms/TutorLMSs-Icon-scaled.webp)

Click the **Toggle** button and your TutorLMS integration module will be enabled.

![Enable Tutor LMS Integration](/images/lms-integrations/integrate-tutor-lms/Enabled-TutorLMS-Integration-scaled.webp)
...
![Open desired form](/images/lms-integrations/integrate-tutor-lms/Open-desired-form-1-scaled.webp)
...
![Add new integration](/images/lms-integrations/integrate-tutor-lms/Add-new-integration-dropdown-TutorLMS-scaled.webp)
...
* **Payment Item Fields:** If your form has multiple **Payment Item** fields (e.g. courses, plans, bundles), you can map each item field individually to your TutorLMS Fields using the **Shortcode** button, alongside your regular form fields.
...
* **Conditional Logics:** This option allows TutorLMS integration to function conditionally based on your submission values according to your set conditional logic/s. Also, here, you can add as much conditional logic as you need by clicking the **+ Add More** button and delete any logic by clicking the **Trash** Icon if needed. To learn more, read this [conditional logic guide](/use-conditional-logic).
...
![Tutor LMS integration settings](/images/lms-integrations/integrate-tutor-lms/Add-New-TutorLMS-Integrartion-Feed-page.webp)
...
![Added Tutor LMS Integration Feed](/images/lms-integrations/integrate-tutor-lms/Added-TutorLMS-integration-feed-scaled.webp)
...
![Preview of Tutor LMS enrollments](/images/lms-integrations/integrate-tutor-lms/Preview-of-TutorLMS-scaled.webp)
