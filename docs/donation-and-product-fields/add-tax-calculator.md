---
title: "Add Tax Calculated Amount Field"
category: "Donation and Product Fields"
---
# Add Tax Calculation to Forms
...
![Access Form Editor](/images/donation-and-product-fields/add-tax-calculator/1.-Open-desired-form-4-scaled.webp)
...
![Add Field Options](/images/donation-and-product-fields/add-tax-calculator/2.-Type-or-click-icon-4.webp)

Select "Tax Calculated Amount" under "Donation & Product Fields":

![Select Tax Field](/images/donation-and-product-fields/add-tax-calculator/3.-Tax-Calculated-field.webp)

## Configuring Tax Calculation

To customize the field, click the **Settings Icon** in the right corner:

![Access Settings](/images/donation-and-product-fields/add-tax-calculator/4.-Settings-Icon-4.webp)
...
![General Settings](/images/donation-and-product-fields/add-tax-calculator/5.-General-Settings-2.webp)
...
![Advanced Settings](/images/donation-and-product-fields/add-tax-calculator/6.-Advanced-Field.webp)
...
![Form Management Options](/images/donation-and-product-fields/add-tax-calculator/7.-Save-preview-shortcode-buttons.webp)

## Preview

Here's how your tax calculation will appear to customers:

![Tax Calculation Preview](/images/donation-and-product-fields/add-tax-calculator/8.-Preview-of-Tax-Calculated-amount.webp)
