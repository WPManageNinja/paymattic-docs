...
![Open desired form](/images/donation-and-product-fields/add-item-quantity/1.-Open-desired-form-2-scaled.webp)
...
![Type / or click + icon](/images/donation-and-product-fields/add-item-quantity/2.-Type-or-click-icon-2.webp)
...
![Item Quantity Field](/images/donation-and-product-fields/add-item-quantity/3.-Item-Quantity-Field.webp)
...
![Settings Icon](/images/donation-and-product-fields/add-item-quantity/4.-Settings-Icon-2.webp)
...
![General settings tab](/images/donation-and-product-fields/add-item-quantity/5.-General-settings-tab.webp)
...
![Advanced Settings](/images/donation-and-product-fields/add-item-quantity/6.-Advanced-Settings.webp)
...
![Save, preview and shortcode buttons](/images/donation-and-product-fields/add-item-quantity/7.-Save-preview-and-shortcode-buttons.webp)

## Preview of Item Quantity field

Here is the preview of the **Item Quantity** field in a Form.

![Preview of Item Quantity field](/images/donation-and-product-fields/add-item-quantity/8.-Preview-of-Item-Quantity-field.webp)
