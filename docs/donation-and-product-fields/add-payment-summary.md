...
In [Paymattic](https://paymattic.com/), the **Payment Summary** field allows users to view a summary of their total payments based on the selected items or products and you can use it in any [Payment Form](/create-payment-form).
...
![Open desired form](/images/donation-and-product-fields/add-payment-summary/1.-Open-desired-form-scaled.webp)
...
![Type / or click + icon](/images/donation-and-product-fields/add-payment-summary/2.-Type-or-click-icon.webp)
...
![Payment Summary field](/images/donation-and-product-fields/add-payment-summary/3.-Payment-Summary-field.webp)
...
![Settings Icon](/images/donation-and-product-fields/add-payment-summary/4.-Settings-Icon.webp)
...
![General Settings](/images/donation-and-product-fields/add-payment-summary/5.-General-Settings.webp)
...
![Advanced Settings](/images/donation-and-product-fields/add-payment-summary/6.-Advanced-Settings.webp)
...
![Save, preview and shortcode buttons](/images/donation-and-product-fields/add-payment-summary/7.-Save-preview-and-shortcode-buttons.webp)

## Preview of Payment Summary field

Here is the preview of the **Payment Summary** field in a Form.

![Preview of Payment Summary](/images/donation-and-product-fields/add-payment-summary/8.-Preview-of-Payment-Summary.webp)
