...
---
https://www.youtube.com/watch?v=fzeIsWGljc0&amp;list=PLXpD0vT4thWH80g5e9wYnoBMgEqUXbr53&amp;index=9 
...
- *Tabular Product Items** is a premium feature and you need [**Paymattic Pro Plugin**](/# 1-toc-title) to use this field**.**

Additionally, with the **[Grid Template](/# 6-toc-title)** and **[Single Line Template](/# 10-toc-title)**, you can build the **Shopping Cart/s** to showcase your products in your forms.

## Adding Tabular Product Items

To learn how to add the Tabular Prodect Items to the Paymattic Form on your WordPress site, follow the steps with the screenshots below –
...
![](/images/donation-and-product-fields/how-to-add-tabular-product-item-fields-in-wordpress-with-paymattic/Open-desired-form-3-scaled.webp)
...
![](/images/donation-and-product-fields/how-to-add-tabular-product-item-fields-in-wordpress-with-paymattic/Type-or-click-icon.webp)

For example, I choose the **Type “/” to insert fields** option to select the **Tabular Product Items** field.

![](/images/donation-and-product-fields/how-to-add-tabular-product-item-fields-in-wordpress-with-paymattic/choose-Tabular-Product-Item-field.webp)

## Editing/Customizing the Field

You can see the **Tabular Prodect Items** field is added to the form.

You can **edit** the **Product's** **Name** and set the **Item's Price** and **Default** **Quantity** for each product by clicking the **Pencil Icon** right next to **each column &amp; raw**.

To get all the edit options of the **Tabular Prodect Items** field, click the **Settings Icon** in the right-side corner.

![](/images/donation-and-product-fields/how-to-add-tabular-product-item-fields-in-wordpress-with-paymattic/Settings-Icon.webp)
...
![](/images/donation-and-product-fields/how-to-add-tabular-product-item-fields-in-wordpress-with-paymattic/Choose-Tabular-Template.webp)
...
![](/images/donation-and-product-fields/how-to-add-tabular-product-item-fields-in-wordpress-with-paymattic/Table-Templates-General-Settings.webp)
...
- *Drag &amp; Drop feature**: This lets you move and organize your product raws smoothly.
...
- *Maximum Quantity**: This lets you set a minimum order quantity for your product, so users cannot order more than this amount.
...
To add new rows to the table, click on the **+ Add More** button**.** Also**,** click the **Trash** **Icon** to delete a raw anytime if needed.
...
![](/images/donation-and-product-fields/how-to-add-tabular-product-item-fields-in-wordpress-with-paymattic/Grid-Templates-generl-Settings-scaled.webp)
...
With drag and drop icon, you can organize the raws smoothly with less time and effort. Also, you can **add multiple extra prices** by clicking the **+ Add More** button and **delete** anytime by clicking the **Trash** Icon if needed. Plus, to set multiple criteria for setting the extra price, click the **+Add More Options** button.
...
![](/images/donation-and-product-fields/how-to-add-tabular-product-item-fields-in-wordpress-with-paymattic/Preview-of-Single-Line-template.webp)
...
![](/images/donation-and-product-fields/how-to-add-tabular-product-item-fields-in-wordpress-with-paymattic/Advanced-Settings.webp)
...
![](/images/donation-and-product-fields/how-to-add-tabular-product-item-fields-in-wordpress-with-paymattic/Save-preview-and-Shortcode-buttons-scaled.webp)

## Preview of Tabular Product Items field

Here is the preview of the **Tabular Product Items** fields in a Form.

![](/images/donation-and-product-fields/how-to-add-tabular-product-item-fields-in-wordpress-with-paymattic/Preview-of-Integrated-Donation-Form.webp)
