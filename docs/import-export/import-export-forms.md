...
![Add new form](/images/import-export/import-export-forms/Add-New-Form-button-scaled.webp)

Now, click the **Import Form** tab as it allows you to import your JSON format forms from other platforms to Paymattic.

![Import tab](/images/import-export/import-export-forms/Import-Form-tab-scaled.webp)
...
![Import form](/images/import-export/import-export-forms/Import-Button.webp)

Here, you can see that the form is **imported successfully** and added to All Forms sections.

![Imported form](/images/import-export/import-export-forms/Preview-of-imported-form-scaled.webp)
...
![Export form](/images/import-export/import-export-forms/Export-Form-button-scaled.webp)
