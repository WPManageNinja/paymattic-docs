...
To export form entries, you must have the [Paymattic Pro](/install-paymattic) Plugin installed and activated on your site.
:::
...
![View entry details](/images/import-export/export-form-entries/View-Details-button-scaled.webp)
...
![Export single entry](/images/import-export/export-form-entries/Export-as-JOSN-for-a-single-entry-scaled.webp)
...
![Access entries](/images/import-export/export-form-entries/Entries-button-in-All-Forms-section-scaled.webp)
...
![Export format options](/images/import-export/export-form-entries/Export-Dropdown-scaled.webp)
