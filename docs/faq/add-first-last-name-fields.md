...
>[!Note]
>If you do not have any existing forms, read this [Create a Form](/create-form-from-scratch) from Scratch or Create a Form [Using templates](/simple-form-templates) documentation to create one.

For example, here, I used an existing blank form to show the whole process.

![Open form](/images/faq/add-first-last-name-fields/1.-Open-desired-form-2-scaled.webp)

Once you open the **Editor** page, add the necessary fields by typing the “** /** ” or clicking the **Plus Icon** placed at the bottom.

![Add fields](/images/faq/add-first-last-name-fields/2.-Type-2222-or-2222.webp)

>[!Note]
>Now, from the [General Fields](/use-general-input-fields) section, you can either choose the Two Column Container field to display two different fields horizontally or select the Name field twice to show them vertically.

![Choose field type](/images/faq/add-first-last-name-fields/3.-Select-either-Name-or-Two-Column-Container-field.webp)
...
![Add container](/images/faq/add-first-last-name-fields/4.-Two-Column-Container.webp)
...
![Add name fields](/images/faq/add-first-last-name-fields/4.-Plus-Icon.webp)
...
![Select name field](/images/faq/add-first-last-name-fields/5.-Name-field.webp)
...
![Edit labels](/images/faq/add-first-last-name-fields/6.-Pencil-Icon.webp)

To change the name in the **Admin Label**, click the **Settings Icon** of the **Name** fields.


![Settings access](/images/faq/add-first-last-name-fields/8.-Settings-icon-of-Name-field.webp)
...
![Advanced settings](/images/faq/add-first-last-name-fields/9.-Advanced-Settings-of-Name-field.webp)

### Additional Customization

For more customization options, see:
- [Two Column Container guide](/add-multiple-columns)
- [Name field options](/use-general-input-fields#_1-name-field)
- [Advanced field settings](/use-conditional-logic)
...
![Save options](/images/faq/add-first-last-name-fields/7.-Save-preview-shortcode-buttons.webp)

Here, you can see the preview of the separately added First Name and Last Name fields.

![Final preview](/images/faq/add-first-last-name-fields/8.-Preview-of-added-First-Last-Name-fields.webp)
