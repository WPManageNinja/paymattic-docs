...
![Access subscription entry](/images/manage-form-entries/cancel-subscription/Desired-Form-Entry-for-Cancellation-1-2-scaled.webp)
...
![Cancel subscription](/images/manage-form-entries/cancel-subscription/Cancel-Subscription-1.webp)
...
![Access subscription entry](/images/manage-form-entries/cancel-subscription/Desired-Form-Entry-for-Cancellation-1-1-scaled.webp)
...
>- [Moneris](/integrate-moneris)

![View in payment gateway](/images/manage-form-entries/cancel-subscription/View-on-Stripe.webp)

6. In the payment gateway dashboard, Open the **Actions** dropdown and Click the **Cancel Subscription** options.

![Cancel in payment gateway](/images/manage-form-entries/cancel-subscription/Cancel-from-Payment-methods-dashboard-scaled.webp)
...
![Enable user cancellation](/images/manage-form-entries/cancel-subscription/Cancel-Subscription-from-User-End-scaled.webp)
