---
title: "Disable IP Address Logging"
...
![IP address settings](/images/manage-form-entries/disable-ip-logging/1.-Other-Settings-scaled.webp)
...
![Access entry details](/images/manage-form-entries/disable-ip-logging/2.-desired-form-entry-scaled.webp)

Here, you can see the **IP Address** is visible of a specific user under the **Meta Info** section on the right side. 

![View IP address](/images/manage-form-entries/disable-ip-logging/3.-View-IP-Address-scaled.webp)
...
![Empty IP address](/images/manage-form-entries/disable-ip-logging/4.-empty-ip-address-scaled.webp)
