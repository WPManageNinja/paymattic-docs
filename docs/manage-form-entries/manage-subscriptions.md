...
![Access subscription entry](/images/manage-form-entries/manage-subscriptions/1.-Open-desired-entry-scaled.webp)
...
![Related payments section](/images/manage-form-entries/manage-subscriptions/2.-Related-Payments-scaled.webp)

Click the **Change Subscription Payment** Status button and a pop-up will appear.

![Change subscription status](/images/manage-form-entries/manage-subscriptions/3.-Change-Subscription-Payment-Status.webp)
...
![Edit payment status](/images/manage-form-entries/manage-subscriptions/4.-Edit-Payment-status-pop-up.webp)

To change the Payment Status for the whole Entry, click the **Change Payment Status** button on the top right corner.

![Change overall payment status](/images/manage-form-entries/manage-subscriptions/5.-Change-Payment-Status-scaled.webp)
...
![Confirm status change](/images/manage-form-entries/manage-subscriptions/6.-Confirm-button.webp)

The system will update both the payment and subscription status:

![Updated status](/images/manage-form-entries/manage-subscriptions/7.-Paid-Status-scaled.webp)
