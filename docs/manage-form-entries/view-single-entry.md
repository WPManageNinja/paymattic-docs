---
title: "View Single Submission Data and Manage Payments"
category: "Manage Form Entries"
---

# View Single Submission Data and Manage Payments
...
![Access single entry](/images/manage-form-entries/view-single-entry/1.-Open-desired-form-entry-from-Entries-section-scaled.webp)
...
![Entry details overview](/images/manage-form-entries/view-single-entry/2.-Entire-detail-of-an-entry-scaled.webp)
...
![Change payment status](/images/manage-form-entries/view-single-entry/3.-Change-payment-status.webp)
...
![Edit payment status](/images/manage-form-entries/view-single-entry/4.-Edit-Payment-Status-Pop-up.webp)
...
* **Send Email Notification Manually:** Click this button to send an email notification to the Admin/User manually for this entry. To learn the process of doing it, [click here](/setup-email-notifications).

![Entry actions](/images/manage-form-entries/view-single-entry/5.-Entry-Actions.webp)
...
![Form entry data](/images/manage-form-entries/view-single-entry/6.-Form-entry-data.webp)

### D. Payment Items

Here, you can see the ordered payment item/s Name, Quantity, Meta option data, and price (both single, subtotal, and total). 

![Payment items](/images/manage-form-entries/view-single-entry/7.-Payment-Items.webp)
...
![Transaction details](/images/manage-form-entries/view-single-entry/8.-Transaction-details.webp)
...
![Submission activity](/images/manage-form-entries/view-single-entry/9.-Submission-Eventt-Activity.webp)

### G. FluentCRM Profile 

This section will only appear in a form entry if the user is a [FluentCRM](http://fluentcrm.com) user.

![FluentCRM profile](/images/manage-form-entries/view-single-entry/10.-Fluent-CRM-Profile.webp)

#### H. Meta Info

By enabling this option, you can see the Meta information about the user who submitted this form.
![Meta information](/images/manage-form-entries/view-single-entry/11.-Meta-Info.webp)
