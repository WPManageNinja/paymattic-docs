---
title: "Create PDF Feed for Form Submissions"
category: "Form Editor"
---

# Create PDF Feed for Form Submissions
...
![](/images/form-editor/create-pdf-feed/Install-Activate-Fluent-PDF--scaled.webp)

Go to the **Fluent PDF Dashboard** link

![](/images/form-editor/create-pdf-feed/Go-to-fluent-pdf-dashboard-link-scaled.webp)

Click the **Install Fonts** button to install the required pdf fonts.

![](/images/form-editor/create-pdf-feed/Install-Fonts.webp)

Your Fluent PDF Module is active so you can use the PDF Feed of Paymattic now.

![](/images/form-editor/create-pdf-feed/PDF-Module.webp)
...
![](/images/form-editor/create-pdf-feed/PDF-Settings-page-scaled.webp)
...
![](/images/form-editor/create-pdf-feed/Open-desired-form-scaled.webp)

From the Editor page, go to **Settings**, open the **PDF Feeds** tab, and click the **+ Add PDF Feed** button.

![](/images/form-editor/create-pdf-feed/Add-PDF-Feed-button-scaled.webp)

Now a popup will arrive with two default templates. Select the template as per your need.

Remember, the Invoice Template will only come if you have any **Payment Submissions** in your [Payment Form](/create-payment-form).

![](/images/form-editor/create-pdf-feed/Invoice-template.webp)
...
![](/images/form-editor/create-pdf-feed/PDF-Contents-page.webp)
...
![](/images/form-editor/create-pdf-feed/Appearance-page.webp)
...
![](/images/form-editor/create-pdf-feed/Entries-View-Details-scaled.webp)

From here you will get the **Download** option for your PDF Feed to see the preview of the Feed.

![](/images/form-editor/create-pdf-feed/Pdf-download-option-scaled.webp)
...
For example, I selected the **Admin Email Notification** to show the process. To learn more about Email Notification, read this [Documentation](/setup-email-notifications).

![](/images/form-editor/create-pdf-feed/Email-Notifications-scaled.webp)
...
![](/images/form-editor/create-pdf-feed/Check-the-PDF-Attachments-section-scaled.webp)
