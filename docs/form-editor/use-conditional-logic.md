---
title: "Use Conditional Logic in Form Fields"
category: "Form Editor"
---

# Use Conditional Logic in Form Fields
...
![Opening a form in Paymattic editor](/images/form-editor/use-conditional-logic/Open-desired-form-scaled.webp)

Once you open the **Editor** page, [Add the Desired Fields](/create-form-from-scratch#adding-desired-field-s) by typing the **" / "** or clicking the **Plus Icon** placed at the bottom.
Or, use any existing field to set the conditional logic. For example, I will add the **[Name](/use-general-input-fields#_1-name-field)** and **[Email](/use-general-input-fields#_2-email-field)** field to show you the process.

First, click the **Settings Icon** in the right corner of your field where you wish to use conditional logic.

![Field settings icon location](/images/form-editor/use-conditional-logic/Settings-Icon-of-desired-field.webp)
...
![Enabling conditional render option](/images/form-editor/use-conditional-logic/click-Yes-to-enable-Conditional-Render.webp)
...
![Setting up conditional logic rules](/images/form-editor/use-conditional-logic/Set-desired-conditional-logics-.webp)
...
![Update button to save changes](/images/form-editor/use-conditional-logic/Update-button.webp)
...
![Preview when conditions are not met](/images/form-editor/use-conditional-logic/Preview-of-conditional-logic-doesnt-match.webp)

Here is a **preview** of a form where the user met all the set conditions. As a result, the Email Address is visible here.

![Preview when conditions are met](/images/form-editor/use-conditional-logic/Preview-of-Conditions-matched.webp)
