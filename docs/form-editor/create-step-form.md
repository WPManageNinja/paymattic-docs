...
![Opening an existing form](/images/form-editor/create-step-form/open-desired-form-scaled.webp)

Once you open the **Editor** page, add the necessary fields by typing the **" / "** or clicking the **Plus Icon** placed at the bottom.

![Adding fields using slash or plus icon](/images/form-editor/create-step-form/type-22-22-or-click-2222-to-add-desired-fileds.webp)
...
![Step form field selection](/images/form-editor/create-step-form/Step-Form-field.webp)
...
![Step form customization options](/images/form-editor/create-step-form/Step-name-editor-icon-to-add-steps-2222-icon-to-insert-fields.webp)
...
::: tip Note
Remember, almost every step has a similar functionality for adding and customizing field/s. For example, I chose the **[Name](/use-general-input-fields#_1-name-field)** and **[Email](/use-general-input-fields#_2-email-field)** field to show the process.
:::

![Next and delete step buttons](/images/form-editor/create-step-form/Next-and-Delete-button.webp)
...
![Save, preview and shortcode buttons](/images/form-editor/create-step-form/Save-preview-shortcode-buttons-scaled.webp)
...
![User information step](/images/form-editor/create-step-form/User-Information.webp)

### Step 2: Products
![Products step](/images/form-editor/create-step-form/Products.webp)

### Step 3: Payment Methods
![Payment methods step](/images/form-editor/create-step-form/Payment-methods.webp)
