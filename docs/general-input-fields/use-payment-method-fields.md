---
title: "Use the Payment Method Fields"
category: "General Input Fields"
---

# Use the Payment Method Fields
...
![Open Form Editor](/images/general-input-fields/use-payment-method-fields/open-desired-form-1-scaled.webp)

Once you open the **Editor** page, type the **"/"** or click the **"+"** icon placed at the bottom to get the Payment Method Fields section.

![Add Field Options](/images/general-input-fields/use-payment-method-fields/type-2222-or-click-2222-to-get-payment-method-fields.webp)
...
![Payment Method Fields Section](/images/general-input-fields/use-payment-method-fields/All-Payment-Method-Fields-2.webp)
...
![Single Payment Method Options](/images/general-input-fields/use-payment-method-fields/Payment-Method-Fields.webp)
...
![Multiple Payment Method Options](/images/general-input-fields/use-payment-method-fields/Choose-Payment-Method-Fields-1.webp)
...
![Settings Icon](/images/general-input-fields/use-payment-method-fields/Settings-Icon-of-Payment-Method-field.webp)
...
![General Settings](/images/general-input-fields/use-payment-method-fields/General-Settings-of-Stripe.webp)
...
![Advanced Settings](/images/general-input-fields/use-payment-method-fields/Advanced-settings-of-Payment-method-field-1.49.26-AM.webp)
...
Remember, your Payment Method field will not work until you have any [Product Field](/use-product-fields) in your form. For example, I added the [Payment Item](/donation-and-product-fields/how-to-add-payment-item-fields-in-wordpress-with-paymattic) field as a product field.

![Form Management Options](/images/general-input-fields/use-payment-method-fields/Save-and-Preview-.webp)

Here is the **preview** of the added **Payment Method** fields in a **Form**.

![Payment Method Preview](/images/general-input-fields/use-payment-method-fields/Preview-of-Payment-Method.webp)
